...
Secrets requeridos en .streamlit/secrets.toml:
    SUPABASE_URL = "https://iccryrwqlzczaduouevh.supabase.co"
    SUPABASE_KEY = ""eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJzdXBhYmFzZSIsInJlZiI6ImljY3J5cndxbHpjemFkdW91ZXZoIiwicm9sZSI6ImFub24iLCJpYXQiOjE3ODM5NzE0NjIsImV4cCI6MjA5OTU0NzQ2Mn0.kGxic0WExFwtq-H_DU_csM5U0ouQzTfzImc-jYQ3Lq8""
    DELETE_PASSWORD = "Dmsnp8a"  # opcional, pero recomendado
"""
